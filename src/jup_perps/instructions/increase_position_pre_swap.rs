...
impl IncreasePositionPreSwap {
  pub fn instruction(&self, args: IncreasePositionPreSwapInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: IncreasePositionPreSwapInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = IncreasePositionPreSwapInstructionData::new().try_to_vec().unwrap();
