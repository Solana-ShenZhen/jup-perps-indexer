...
use crate::generated::types::GetPnlAndFeeParams;
...
impl GetPnl {
  pub fn instruction(&self, args: GetPnlInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: GetPnlInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = GetPnlInstructionData::new().try_to_vec().unwrap();
...
pub struct GetPnlInstructionData {
            discriminator: [u8; 8],
            }

impl GetPnlInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for GetPnlInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct GetPnlInstructionArgs {
                  pub params: GetPnlAndFeeParams,
      }


/// Instruction builder for `GetPnl`.
///
/// ### Accounts:
///
          ///   0. `[]` perpetuals
          ...
          ///   5. `[]` collateral_custody
                ///   6. `[optional]` custody_price_update
#[derive(Clone, Debug, Default)]
pub struct GetPnlBuilder {
            perpetuals: Option<solana_program::pubkey::Pubkey>,
                ...
                custody_price_update: Option<solana_program::pubkey::Pubkey>,
                        params: Option<GetPnlAndFeeParams>,
...
#[inline(always)]
    pub fn custody_price_update(&mut self, custody_price_update: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn params(&mut self, params: GetPnlAndFeeParams) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = GetPnl {
          ...
          let args = GetPnlInstructionArgs {
  ...
  /// `get_pnl` CPI accounts.
  pub struct GetPnlCpiAccounts<'a, 'b> {
...
/// `get_pnl` CPI instruction.
pub struct GetPnlCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: GetPnlInstructionArgs,
  }

impl<'a, 'b> GetPnlCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: GetPnlCpiAccounts<'a, 'b>,
              args: GetPnlInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `GetPnl` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` perpetuals
          ...
          ///   5. `[]` collateral_custody
                ///   6. `[optional]` custody_price_update
#[derive(Clone, Debug)]
pub struct GetPnlCpiBuilder<'a, 'b> {
  instruction: Box<GetPnlCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> GetPnlCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(GetPnlCpiBuilderInstruction {
      __program: program,
              perpetuals: None,
              pool: None,
              position: None,
...
#[derive(Clone, Debug)]
struct GetPnlCpiBuilderInstruction<'a, 'b> {
