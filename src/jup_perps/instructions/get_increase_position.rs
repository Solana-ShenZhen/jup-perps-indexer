...
use crate::jup_perps::types::GetIncreasePositionParams;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;
use crate::jup_perps::programs::PERPETUALS_ID;

/// Accounts.
pub struct GetIncreasePosition {
    pub perpetuals: solana_program::pubkey::Pubkey,

    pub pool: solana_program::pubkey::Pubkey,

    pub position: Option<solana_program::pubkey::Pubkey>,
...
impl GetIncreasePosition {
    pub fn instruction(
        &self,
        args: GetIncreasePositionInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = GetIncreasePositionInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct GetIncreasePositionInstructionData {
    discriminator: [u8; 8],
}

impl GetIncreasePositionInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [101, 131, 0, 32, 246, 54, 251, 101],
        }
    }
}

impl Default for GetIncreasePositionInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct GetIncreasePositionInstructionArgs {
    pub params: GetIncreasePositionParams,
}

/// Instruction builder for `GetIncreasePosition`.
///
/// ### Accounts:
///
///   0. `[]` perpetuals
...
pub struct GetIncreasePositionBuilder {
    ...
    params: Option<GetIncreasePositionParams>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl GetIncreasePositionBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn position(&mut self, position: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
    ...
    #[inline(always)]
    pub fn params(&mut self, params: GetIncreasePositionParams) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = GetIncreasePosition {
        ...
        let args = GetIncreasePositionInstructionArgs {
...
/// `get_increase_position` CPI accounts.
pub struct GetIncreasePositionCpiAccounts<'a, 'b> {
    pub perpetuals: &'b solana_program::account_info::AccountInfo<'a>,

    pub pool: &'b solana_program::account_info::AccountInfo<'a>,

    pub position: Option<&'b solana_program::account_info::AccountInfo<'a>>,
...
/// `get_increase_position` CPI instruction.
pub struct GetIncreasePositionCpi<'a, 'b> {
    ...
    pub __args: GetIncreasePositionInstructionArgs,
}

impl<'a, 'b> GetIncreasePositionCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: GetIncreasePositionCpiAccounts<'a, 'b>,
        args: GetIncreasePositionInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `GetIncreasePosition` via CPI.
///
/// ### Accounts:
///
///   0. `[]` perpetuals
...
///   8. `[optional]` collateral_custody_price_update
#[derive(Clone, Debug)]
pub struct GetIncreasePositionCpiBuilder<'a, 'b> {
    instruction: Box<GetIncreasePositionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> GetIncreasePositionCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(GetIncreasePositionCpiBuilderInstruction {
            __program: program,
            perpetuals: None,
            pool: None,
            position: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = GetIncreasePositionCpi {
...
#[derive(Clone, Debug)]
struct GetIncreasePositionCpiBuilderInstruction<'a, 'b> {
