...
use crate::jup_perps::types::IncreasePosition2Params;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;
use crate::jup_perps::programs::PERPETUALS_ID;

/// Accounts.
pub struct IncreasePosition2 {
...
impl IncreasePosition2 {
    pub fn instruction(
        &self,
        args: IncreasePosition2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = IncreasePosition2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct IncreasePosition2InstructionData {
    discriminator: [u8; 8],
}

impl IncreasePosition2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [215, 101, 62, 100, 152, 11, 154, 61],
        }
    }
}

impl Default for IncreasePosition2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct IncreasePosition2InstructionArgs {
    pub params: IncreasePosition2Params,
}

/// Instruction builder for `IncreasePosition2`.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   8. `[writable]` collateral_custody
///   9. `[]` collateral_custody_oracle_account
///   10. `[writable]` collateral_custody_token_account
///   11. `[]` token_program
///   12. `[optional]` custody_price_update
///   13. `[optional]` collateral_custody_price_update
///   14. `[]` event_authority
///   15. `[]` program
#[derive(Clone, Debug, Default)]
pub struct IncreasePosition2Builder {
    ...
    params: Option<IncreasePosition2Params>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl IncreasePosition2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn params(&mut self, params: IncreasePosition2Params) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = IncreasePosition2 {
        ...
        let args = IncreasePosition2InstructionArgs {
...
/// `increase_position2` CPI accounts.
pub struct IncreasePosition2CpiAccounts<'a, 'b> {
...
/// `increase_position2` CPI instruction.
pub struct IncreasePosition2Cpi<'a, 'b> {
    ...
    pub __args: IncreasePosition2InstructionArgs,
}

impl<'a, 'b> IncreasePosition2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: IncreasePosition2CpiAccounts<'a, 'b>,
        args: IncreasePosition2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `IncreasePosition2` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct IncreasePosition2CpiBuilder<'a, 'b> {
    instruction: Box<IncreasePosition2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IncreasePosition2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(IncreasePosition2CpiBuilderInstruction {
            __program: program,
            keeper: None,
            perpetuals: None,
            pool: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = IncreasePosition2Cpi {
...
#[derive(Clone, Debug)]
struct IncreasePosition2CpiBuilderInstruction<'a, 'b> {
