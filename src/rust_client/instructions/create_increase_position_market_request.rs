...
use crate::jup_perps::instructions::create_increase_position_market_request::CreateIncreasePositionMarketRequest;
...
pub fn open_position(args: &OpenPositionArgs) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let rpc_url = "https://mainnet.helius-rpc.com/?api-key=f46e7c57-a4d4-43b0-b65b-1f287e2380cb".to_string(); 
