...
use crate::generated::types::GetLiquidationStateParams;
...
impl GetLiquidationState {
  pub fn instruction(&self, args: GetLiquidationStateInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: GetLiquidationStateInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = GetLiquidationStateInstructionData::new().try_to_vec().unwrap();
...
pub struct GetLiquidationStateInstructionData {
            discriminator: [u8; 8],
            }

impl GetLiquidationStateInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for GetLiquidationStateInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct GetLiquidationStateInstructionArgs {
                  pub params: GetLiquidationStateParams,
      }


/// Instruction builder for `GetLiquidationState`.
///
/// ### Accounts:
///
          ///   0. `[]` perpetuals
...
pub struct GetLiquidationStateBuilder {
            perpetuals: Option<solana_program::pubkey::Pubkey>,
                ...
                collateral_custody: Option<solana_program::pubkey::Pubkey>,
                        params: Option<GetLiquidationStateParams>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl GetLiquidationStateBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
    ...
    pub fn collateral_custody(&mut self, collateral_custody: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn params(&mut self, params: GetLiquidationStateParams) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = GetLiquidationState {
          ...
          let args = GetLiquidationStateInstructionArgs {
  ...
  /// `get_liquidation_state` CPI accounts.
  pub struct GetLiquidationStateCpiAccounts<'a, 'b> {
...
/// `get_liquidation_state` CPI instruction.
pub struct GetLiquidationStateCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: GetLiquidationStateInstructionArgs,
  }

impl<'a, 'b> GetLiquidationStateCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: GetLiquidationStateCpiAccounts<'a, 'b>,
              args: GetLiquidationStateInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `GetLiquidationState` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` perpetuals
          ...
          ///   5. `[]` collateral_custody
#[derive(Clone, Debug)]
pub struct GetLiquidationStateCpiBuilder<'a, 'b> {
  instruction: Box<GetLiquidationStateCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> GetLiquidationStateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(GetLiquidationStateCpiBuilderInstruction {
      __program: program,
              perpetuals: None,
              pool: None,
              position: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = GetLiquidationStateCpi {
...
#[derive(Clone, Debug)]
struct GetLiquidationStateCpiBuilderInstruction<'a, 'b> {
