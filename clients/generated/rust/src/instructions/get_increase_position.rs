...
use crate::generated::types::GetIncreasePositionParams;
...
impl GetIncreasePosition {
  pub fn instruction(&self, args: GetIncreasePositionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: GetIncreasePositionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = GetIncreasePositionInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> GetIncreasePositionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn pool(&mut self, pool: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn position(&mut self, position: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
