...
export type CreateDecreasePositionRequest2Params = {
...
export type CreateDecreasePositionRequest2ParamsArgs = {
...
export function getCreateDecreasePositionRequest2ParamsSerializer(): Serializer<
  CreateDecreasePositionRequest2ParamsArgs,
  CreateDecreasePositionRequest2Params
> {
  return struct<CreateDecreasePositionRequest2Params>(
    [
    ...
    { description: 'CreateDecreasePositionRequest2Params' }
  ) as Serializer<
    CreateDecreasePositionRequest2ParamsArgs,
    CreateDecreasePositionRequest2Params
  >;
